...
import torch
from cs336_systems.FlashAttention.flash_att_pytorch import PytorchFlashAttention
from cs336_systems.FlashAttention.flash_attn_triton import TritonFlashAttention
from cs336_systems.Parallel.ddp_individual import DDPIndividualParameters
from cs336_systems.Parallel.ddp_overlap_bucketed import DDPOverlapBucketParameter
from cs336_systems.Parallel.optimizer_state_sharding import ShardedOptimizer
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    return DDPOverlapBucketParameter(module, bucket_size_mb)
